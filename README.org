...
- *Performance*: To my knowledge, this is the second fastest Deflate decoder and
  ...
  implementations, depending on the format. Among CL libraries, we're only
...
you will probably not run into this.
...
- The total compressed and uncompressed data of a single member are each limited
