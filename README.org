...
3bz is slightly faster for gzip data and noticeably faster for zlib data. Under
ABCL, Mai's Deflate is faster. Preserving trailing data hurts a lot for Deflate
but not much for the other formats.

| comparison implementation |     SBCL      |     CCL     |     ECL     |     ABCL      |
|---------------------------+---------------+-------------+-------------+---------------|
| /                         |      <c>      |     <c>     |     <c>     |      <c>      |
| /                         |       <       |             |             |               |
| chipz (deflate/zlib/gzip) |  1.77x-2.78x  | 1.39x-1.88x | 1.61x-2.30x |  1.12x-3.52x  |
| chipz (bzip2)             |  1.31x-1.88x  | 2.04x-2.78x | 2.17x-2.47x |  2.46x-7.80x  |
| deflate (with checksum)   |  2.03x-3.57x  | 1.33x-3.91x | 1.87x-3.24x | *0.34x-0.94x* |
| deflate (no checksum)     |  1.34x-3.31x  | 1.23x-1.71x | 1.75x-2.09x | *0.32x-0.93x* |
| 3bz                       | *0.63x-0.96x* | 1.07x-1.54x | 2.12x-7.23x |  1.03x-3.45x  |
|---------------------------+---------------+-------------+-------------+---------------|
| zlib                      |  0.31x-0.54x  | 0.04x-0.12x | 1.00%-2.65% |  0.18%-0.26%  |
| bzip2                     |  0.65x-0.81x  | 0.19x-0.22x | 4.15%-5.39% |  1.06%-2.16%  |
| xz                        |  0.49x-0.62x  | 0.10x-0.17x | 1.04%-1.69% |  0.21%-0.41%  |
...
| /                          |         |      < |           |           |        |        |          |
|                            |     <r> |    <r> |       <r> |       <r> |    <r> |    <r> |      <r> |
| openjdk-17.0.6_p10.tar.gz  |  2.618s | 5.661s |    6.166s |    7.935s | 13.75s | 10.34s |   12.49s |
| openh264-2.3.1.tar.gz      |  0.280s | 0.858s |    0.893s |    1.341s | 1.580s | 2.956s |   3.185s |
| gimp-2.10.32.tar.bz2       |  6.687s |      - |    9.897s |    10.48s | 14.09s |      - |        - |
| gcc-11.3.0.tar.xz          |  7.263s |      - |    14.90s |    14.92s |      - |      - |        - |
| ccl-1.12.1-linuxx86.tar.gz |  0.427s | 0.952s |    1.058s |    1.416s | 2.164s | 2.013s |   2.267s |
| sbcl-2.3.3-source.tar.bz2  |  1.408s |      - |    2.017s |    2.152s | 3.517s |      - |        - |
| Python-3.11.4.tar.xz       |  1.618s |      - |    3.093s |    3.083s |      - |      - |        - |
| html_standard.html.z       |  0.053s | 0.076s |    0.110s |    0.143s | 0.273s | 0.185s |   0.259s |
| pepper.z                   |  0.148s | 0.174s |    0.276s |    0.313s | 0.767s | 0.369s |   0.664s |
| mario.z                    |  0.018s | 0.033s |    0.040s |    0.056s | 0.091s | 0.083s |   0.100s |
| html_standard.html.bz2     |  0.373s |      - |    0.576s |    0.600s | 0.757s |      - |        - |
| pepper.bz2                 |  0.512s |      - |    0.705s |    0.734s | 1.025s |      - |        - |
| mario.bz2                  |  0.110s |      - |    0.135s |    0.147s | 0.254s |      - |        - |
| html_standard.html.lzma    |  0.115s |      - |    0.185s |    0.205s |      - |      - |        - |
| pepper.lzma                |  0.238s |      - |    0.384s |    0.415s |      - |      - |        - |
| mario.lzma                 |  0.065s |      - |    0.107s |    0.119s |      - |      - |        - |
| html_standard.html.xz      |  0.121s |      - |    0.221s |    0.221s |      - |      - |        - |
...
| /                          |      < |           |           |        |        |          |
|                            |    <r> |       <r> |       <r> |    <r> |    <r> |      <r> |
| openjdk-17.0.6_p10.tar.gz  | 53.40s |    37.66s |    39.09s | 64.60s | 48.82s |   54.33s |
| openh264-2.3.1.tar.gz      | 7.071s |    6.584s |    6.777s | 10.07s | 9.573s |   10.29s |
| gimp-2.10.32.tar.bz2       |      - |    34.72s |    35.31s | 72.54s |      - |        - |
| gcc-11.3.0.tar.xz          |      - |    68.40s |    68.40s |      - |      - |        - |
| ccl-1.12.1-linuxx86.tar.gz | 8.634s |    6.820s |    7.174s | 10.23s | 8.390s |   9.044s |
| sbcl-2.3.3-source.tar.bz2  |      - |    6.454s |    6.860s | 17.92s |      - |        - |
| Python-3.11.4.tar.xz       |      - |    13.26s |    13.15s |      - |      - |        - |
| html_standard.html.z       | 0.828s |    0.646s |    0.681s | 0.963s | 0.902s |   1.565s |
| pepper.z                   | 1.903s |    1.232s |    1.248s | 2.315s | 2.110s |   4.816s |
| mario.z                    | 0.293s |    0.270s |    0.286s | 0.376s | 0.344s |   0.504s |
| html_standard.html.bz2     |      - |    1.715s |    1.787s | 3.757s |      - |        - |
| pepper.bz2                 |      - |    2.349s |    2.390s | 4.798s |      - |        - |
| mario.bz2                  |      - |    0.503s |    0.515s | 1.288s |      - |        - |
| html_standard.html.lzma    |      - |    0.698s |    0.731s |      - |      - |        - |
| pepper.lzma                |      - |    1.416s |    1.454s |      - |      - |        - |
| mario.lzma                 |      - |    0.429s |    0.442s |      - |      - |        - |
| html_standard.html.xz      |      - |    1.015s |    1.020s |      - |      - |        - |
| pepper.xz                  |      - |    2.598s |    2.610s |      - |      - |        - |
| mario.xz                   |      - |    0.510s |    0.507s |      - |      - |        - |
...
Mai's Deflate ends up being the fastest and all other Deflate implementations
perform close to the point of unusability.

Our bzip2/XZ performance isn't that bad compared to ECL, likely due to the lower
amount of bit diddling; note however how harshly the runtime increases for the
(highly-compressed, hence copy-heavy) ~pepper.dat~.

| file                    |    3bz | decom (M) | decom (S) |  chipz |   defl | defl (C) |
|-------------------------+--------+-----------+-----------+--------+--------+----------|
| /                       |      < |           |           |        |        |          |
|                         |    <r> |       <r> |       <r> |    <r> |    <r> |      <r> |
| html_standard.html.z    | 52.78s |    23.54s |    26.76s | 55.66s | 17.30s |   17.61s |
| pepper.z                | 85.46s |    83.13s |    97.38s | 92.91s | 26.50s |   28.65s |
| mario.z                 | 24.25s |    7.021s |    8.783s | 24.68s | 6.506s |   6.598s |
| html_standard.html.bz2  |      - |    17.76s |    20.84s | 101.3s |      - |        - |
| pepper.bz2              |      - |    48.34s |    51.39s | 118.9s |      - |        - |
| mario.bz2               |      - |    5.096s |    6.212s | 39.75s |      - |        - |
| html_standard.html.lzma |      - |    32.36s |    35.23s |      - |      - |        - |
| pepper.lzma             |      - |    111.3s |    117.8s |      - |      - |        - |
| mario.lzma              |      - |    17.10s |    18.48s |      - |      - |        - |
| html_standard.html.xz   |      - |    34.04s |    34.00s |      - |      - |        - |
| pepper.xz               |      - |    117.1s |    116.5s |      - |      - |        - |
| mario.xz                |      - |    16.95s |    16.97s |      - |      - |        - |
