...
The supported multi-member formats are gzip and bzip2. Members of gzip and bzip2
are trivial to handle manually with ~decompress~ or ~make-decompression-stream~
